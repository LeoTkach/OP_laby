...
// порожній конструктор для початкового створення масиву об'єктів класа Train 
Train::Train(){}
// конструктор за параметрами для ініціалізації атрибутів об'єктів масиву конкретними значеннями
